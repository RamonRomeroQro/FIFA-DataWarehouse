...
-----
 ...
 DROP TABLE H_SEASON ;
  ...
  "SUMA" NUMBER NOT NULL ENABLE,
    "DIFERENCIA" NUMBER NOT NULL ENABLE,
...
select p.ID_PARTIDO , s.ID_SEASON, t.DTIEMPOPK, g.GOLESPARTIDO, g.HOMESCORE-g.Awayscore
...
delete FROM H_SEASON;
  open c_hechos;
  LOOP
    fetch c_hechos into  vDPARTIDOSPK, vDSEASONPK , vDTIEMPOPK, vSUMA, vDif;
    exit when c_hechos%NOTFOUND;
    insert into H_SEASON (ID_HECHOS, DTIEMPOPK, DSEASONPK, DPARTIDOSPK, SUMA, DIFERENCIA )
      VALUES (SEQ_H_SEASON.nextval, vDTIEMPOPK, vDSEASONPK, vDPARTIDOSPK, vSUMA, vDif);
    COMMIT;
  END LOOP;
  close c_hechos;
